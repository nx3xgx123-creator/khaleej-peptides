...
export const PRODUCTS: Product[] = [
  // ========================= INJECTION PENS =========================
  {
    ...
    variants: [
      ...
      { label: "30 mg", mg: 30, price: 1100, image: "/products/retatrutide-30mg.png" },
      { label: "40 mg", mg: 40, price: 1250, image: "/products/retatrutide-40mg.png" },
      { label: "50 mg", mg: 50, price: 1400, image: "/products/retatrutide-50mg.png" },
      { label: "60 mg", mg: 60, price: 1500, image: "/products/retatrutide-60mg.png" },
    ],
